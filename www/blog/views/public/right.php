<aside>
  ...
  <div class="viny">
    <dl>
      <dt class="art"><img src="<?php echo static_url('/public/blog/images/artwork.png');?>" alt="专辑"></dt>
      ...
      <dd class="music">
        <audio src="<?php echo static_url('/public/blog/images/nf.mp3');?>" controls></audio>
      </dd>
