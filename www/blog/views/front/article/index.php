<ul class="bloglist">
  ...
  <li>
    <div class="arrow_box">
      ...
      <ul class="textinfo">
        <a href="<?php echo site_url('article/' . $article['id']);?>"><img style="width:150px;height:97px;" src="<?php echo static_url('/static/blog/images/s.jpg');?>" alt="<?php echo htmlspecialchars($article['name']);?>"></a>
        <p><?php echo mb_substr(str_replace('&nbsp;', '', strip_tags($article['content'])), 0, 160, 'utf-8') . '......';?></p>
      </ul>
      <ul class="details">
        <li class="likes"><a href="###"><?php echo $article['hits'] ? $article['hits'] : rand(20, 50);?></a></li>
