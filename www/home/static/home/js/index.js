...
$(function () {
	...
	//$("http://www.waibao6.com/Templates/cn/skin/js/a.arrL").mouseover(function(){stopFocusAm();}).mouseout(function(){starFocustAm();});
	//$("http://www.waibao6.com/Templates/cn/skin/js/a.arrR").mouseover(function(){stopFocusAm();}).mouseout(function(){starFocustAm();});
...
$(".serBox").hover(
  function () {
     ...
     $(this).children(".pic2").animate({left: 62},400);
     $(this).children(".txt1").animate({left: -140},400);
     $(this).children(".txt2").animate({right: 47},400);	 
	 }, 
  function () {
	 $(this).children().stop(false,true);
	 $(this).children(".serBoxOn").fadeOut("slow");
	 $(this).children(".pic1").animate({right:62},400);
     $(this).children(".pic2").animate({left: -110},400);
     $(this).children(".txt1").animate({left: 47},400);
     $(this).children(".txt2").animate({right: -140},400);	
  }
);
...
function zpConClose() {
	...
	$('html,body').animate({ scrollTop: $("#Portfolio").offset().top - 64 + "px" }, 1000, 'easeInOutQuint');
	$('#hdp').html('<iframe id="ifm" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="1920" height="470" src="../../slider/index.html"/*tpa=http://www.waibao6.com/Templates/cn/slider/index.html*/></iframe>');
...
function getZPCon(url){
	...
	$.ajax({url: url,
		success:function(data){
			...
			if ($(".zpBtArrL").attr("title") == "无") $(".zpBtArrL").css("display", "none");
			if ($(".zpBtArrR").attr("title") == "无") $(".zpBtArrR").css("display", "none");
...
//}
	...
	*/
    ...
    //  arrow.style.background = "url(/Templates/cn/skin/images/bdmplabel.png) no-repeat";
    ...
    //}
    //var txt = "TGVISION 双晖传媒", mouseoverTxt = "北京市朝阳区大屯里317号金泉时代C座室" ;
