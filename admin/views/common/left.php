<div id="leftbar">
  <ul class="nav navbar-nav">
	...
	<li class="submenu">
	  <a href="#"><i class="fa fa-th-large"></i> 软件管理 <i class="fa fa-angle-down"></i></a>
	  <ul>
		<li><a href=""><i class="fa fa-tasks"></i> 任务管理</a></li>
		<li><a href=""><i class="fa fa-comment"></i> 通知管理</a></li>
		<li><a href=""><i class="fa fa-line-chart"></i> APP更新</a></li>
	  </ul>
	</li>
  </ul><!-- /.nav-list -->
</div>
