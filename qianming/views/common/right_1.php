         ...
         <div class="m_fous" id="show_flash">
            <div id="slide">
                <ul class="slide_field f_cle">
                    <li class="s1">
                        <a href="<?php echo site_url('list/chaozhuai');?>"><img src="/static/qq/images/201422483132.jpg"  /><b>超拽签名</b></a>
                    </li>
                    <li class="s2">
                        <a href="<?php echo site_url('list/baqi');?>"><img src="/static/qq/images/20142248330.jpg"  /><b>霸气签名</b></a>
                    </li>
                    <li class="s3">
                        <a href="<?php echo site_url('list/jingdian');?>"><img src="/static/qq/images/201422483339.jpg"  /><b>经典签名</b></a>
                    </li>
                    <li class="s4">
                        <a href="<?php echo site_url('list/nvsheng');?>"><img src="/static/qq/images/20142248342.jpg"  /><b>女生签名</b></a>
                    </li>   
                </ul>
                <ul class="slide_nav">
                    <li class="cur">1</li>
