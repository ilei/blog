<div class="g_foot">
    <p>  
        <a href="<?php echo site_url();?>">关于QQ个性签名</a> | 
        <a href="<?php echo site_url();?>">联系方式</a> | 
        <a href="<?php echo site_url();?>">发展历程</a> | 
        <a href="<?php echo site_url();?>" style="cursor:help;">下载帮助(？)</a> | 
        <a href="<?php echo site_url();?>">广告联系</a> | 
        <a href="<?php echo site_url();?>">网站地图</a> | 
        <a href="<?php echo site_url();?>">友情链接</a> |   
    </p>
